...
export default function LoginModal({
  ...
  }, [initialSelectedMode, isOpen, mode]);
  ...
  return (
    <div
      className="fixed inset-0 z-[70] overflow-y-auto bg-slate-950/55 p-3 backdrop-blur-sm md:flex md:items-center md:justify-center md:p-4"
      dir={isRtl ? 'rtl' : 'ltr'}
